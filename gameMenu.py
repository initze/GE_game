...
class Ui_GameMenu(object):
    def setupUi(self, GameMenu):
        ...
        GameMenu.resize(260, 132)
        self.pushButton_Next = QtGui.QPushButton(GameMenu)
        self.pushButton_Next.setGeometry(QtCore.QRect(170, 10, 75, 23))
        ...
        self.pushButton_Quit.setGeometry(QtCore.QRect(170, 40, 75, 23))
        self.pushButton_Quit.setObjectName(_fromUtf8("pushButton_Quit"))
        self.pushButton_Reload = QtGui.QPushButton(GameMenu)
        self.pushButton_Reload.setGeometry(QtCore.QRect(90, 40, 75, 23))
        self.pushButton_Reload.setObjectName(_fromUtf8("pushButton_Reload"))
        self.pushButton_Settings = QtGui.QPushButton(GameMenu)
        self.pushButton_Settings.setGeometry(QtCore.QRect(10, 40, 75, 23))
        self.pushButton_Settings.setObjectName(_fromUtf8("pushButton_Settings"))
        self.label = QtGui.QLabel(GameMenu)
        self.label.setGeometry(QtCore.QRect(10, 100, 111, 20))
        self.label.setObjectName(_fromUtf8("label"))
        self.pushButton_Previous = QtGui.QPushButton(GameMenu)
        self.pushButton_Previous.setGeometry(QtCore.QRect(10, 10, 75, 23))
        self.pushButton_Previous.setObjectName(_fromUtf8("pushButton_Previous"))
        self.pushButton_Solution = QtGui.QPushButton(GameMenu)
        self.pushButton_Solution.setGeometry(QtCore.QRect(90, 10, 75, 23))
        self.pushButton_Solution.setAutoDefault(True)
        self.pushButton_Solution.setObjectName(_fromUtf8("pushButton_Solution"))
        self.lineEdit_Solution = QtGui.QLineEdit(GameMenu)
        self.lineEdit_Solution.setEnabled(False)
        self.lineEdit_Solution.setGeometry(QtCore.QRect(10, 70, 231, 20))
        self.lineEdit_Solution.setObjectName(_fromUtf8("lineEdit_Solution"))
    ...
    def retranslateUi(self, GameMenu):
        ...
        self.pushButton_Previous.setText(_translate("GameMenu", "Previous", None))
        self.pushButton_Solution.setText(_translate("GameMenu", "Solution", None))
